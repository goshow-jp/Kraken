...
class GswDoubleMidJointLegComponent(BaseExampleComponent):
    """Leg Component"""

    def __init__(self, name='legBase', parent=None, *args, **kwargs):

        super(GswDoubleMidJointLegComponent, self).__init__(name, parent, *args, **kwargs)
        ...
        self.knee1OutputTgt = self.createOutput('knee1', dataType='Xfo', parent=self.outputHrcGrp).getTarget()
        self.knee2OutputTgt = self.createOutput('knee2', dataType='Xfo', parent=self.outputHrcGrp).getTarget()
...
class GswDoubleMidJointLegComponentGuide(GswDoubleMidJointLegComponent):
    """Leg Component Guide"""

    def __init__(self, name='leg', parent=None, *args, **kwargs):

        Profiler.getInstance().push("Construct Leg Guide Component:" + name)
        super(GswDoubleMidJointLegComponentGuide, self).__init__(name, parent, *args, **kwargs)
        ...
        self.knee1Ctrl = Control('knee1', parent=self.ctrlCmpGrp, shape="sphere")
        self.knee2Ctrl = Control('knee2', parent=self.ctrlCmpGrp, shape="sphere")
        ...
        self.legGuideKLOp.setInput('mid1', self.knee1Ctrl)
        self.legGuideKLOp.setInput('mid2', self.knee2Ctrl)
        ...
        self.default_data = {
                ...
                "femurXfo": Xfo(Vec3(1.0, 8.69, -0.576)),
                "knee1Xfo": Xfo(Vec3(1.15, 5.26, -0.25)),
                "knee2Xfo": Xfo(Vec3(1.15, 4.26, -0.25)),
                "ankleXfo": Xfo(Vec3(1.25, 0.688, -0.398))
               }
    ...
    def saveData(self):
        ...
        data = super(GswDoubleMidJointLegComponentGuide, self).saveData()

        data['femurXfo'] = self.femurCtrl.xfo
        data['knee1Xfo'] = self.knee1Ctrl.xfo
        data['knee2Xfo'] = self.knee2Ctrl.xfo
    ...
    def loadData(self, data):
        ...
        super(GswDoubleMidJointLegComponentGuide, self).loadData( data )

        self.femurCtrl.xfo = data.get('femurXfo')
        self.knee1Ctrl.xfo = data.get('knee1Xfo')
        self.knee2Ctrl.xfo = data.get('knee2Xfo')
    ...
    def getRigBuildData(self):
        ...
        data = super(GswDoubleMidJointLegComponentGuide, self).getRigBuildData()

        # Values
        femurPosition = self.femurCtrl.xfo.tr
        knee1Position = self.knee1Ctrl.xfo.tr
        ...
        knee1Xfo = Xfo()
        knee2Xfo = Xfo()
        tmp1 = knee2Position.subtract(knee1Position).unit()
        tmp2 = anklePosition.subtract(knee2Position).unit()
        ...
        data['knee1Xfo'] = knee1Xfo
        data['knee2Xfo'] = knee2Xfo
    ...
    def getRigComponentClass(cls):
        ...
        return GswDoubleMidJointLegComponentRig


class GswDoubleMidJointLegComponentRig(GswDoubleMidJointLegComponent):
    """Leg Component"""

    def __init__(self, name='leg', parent=None):

        Profiler.getInstance().push("Construct Leg Rig Component:" + name)
        super(GswDoubleMidJointLegComponentRig, self).__init__(name, parent)
        ...
        # ===============
        # Add Leg Splice Op
        self.legIKKLOp = KLOperator('legKLOp', 'TwoBoneDoubleMidJointIKSolver', 'Kraken')
    ...
    def loadData(self, data=None):
        ...
        super(GswDoubleMidJointLegComponentRig, self).loadData( data )
...
ks.registerComponent(GswDoubleMidJointLegComponentGuide)
ks.registerComponent(GswDoubleMidJointLegComponentRig)
