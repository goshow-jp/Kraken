...
class GswFootComponent(BaseExampleComponent):
    """Foot Component"""

    def __init__(self, name="footBase", parent=None, *args, **kwargs):
        super(GswFootComponent, self).__init__(name, parent, *args, **kwargs)
...
class GswFootComponentGuide(GswFootComponent):
    ...
    def __init__(self, name='foot', parent=None, *args, **kwargs):
        ...
        super(GswFootComponentGuide, self).__init__(name, parent, *args, **kwargs)
    ...
    def saveData(self):
        ...
        data = super(GswFootComponentGuide, self).saveData()
    ...
    def loadData(self, data):
        ...
        super(GswFootComponentGuide, self).loadData(data)
    ...
    def getRigBuildData(self):
        ...
        data = super(GswFootComponentGuide, self).getRigBuildData()
    ...
    def getRigComponentClass(cls):
        ...
        return GswFootComponentRig


class GswFootComponentRig(GswFootComponent):
    """Foot Component"""

    def __init__(self, name="foot", parent=None):

        Profiler.getInstance().push("Construct Neck Rig Component:" + name)
        super(GswFootComponentRig, self).__init__(name, parent)
    ...
    def loadData(self, data=None):
        ...
        super(GswFootComponentRig, self).loadData( data )
...
ks.registerComponent(GswFootComponentGuide)
ks.registerComponent(GswFootComponentRig)
