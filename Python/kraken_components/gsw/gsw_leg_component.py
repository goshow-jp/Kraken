...
class GswLegComponent(BaseExampleComponent):
    """Leg Component"""

    def __init__(self, name='legBase', parent=None, *args, **kwargs):

        super(GswLegComponent, self).__init__(name, parent, *args, **kwargs)
...
class GswLegComponentGuide(GswLegComponent):
    ...
    def __init__(self, name='leg', parent=None, *args, **kwargs):
        ...
        self.default_data = {
                ...
                "kneeXfo": Xfo(Vec3(1.15, 4.76, -0.25)),
    ...
    def saveData(self):
        ...
        data = super(GswLegComponentGuide, self).saveData()
    ...
    def loadData(self, data):
        ...
        super(GswLegComponentGuide, self).loadData( data )
    ...
    def getRigBuildData(self):
        ...
        data = super(GswLegComponentGuide, self).getRigBuildData()
    ...
    def getRigComponentClass(cls):
        ...
        return GswLegComponentRig


class GswLegComponentRig(GswLegComponent):
    """Leg Component"""

    def __init__(self, name='leg', parent=None):

        Profiler.getInstance().push("Construct Leg Rig Component:" + name)
        super(GswLegComponentRig, self).__init__(name, parent)
    ...
    def loadData(self, data=None):
        ...
        super(GswLegComponentRig, self).loadData( data )
...
ks.registerComponent(GswLegComponentGuide)
ks.registerComponent(GswLegComponentRig)
