...
class GswHeadComponent(BaseExampleComponent):
    """Head Component Base"""

    def __init__(self, name='headBase', parent=None, *args, **kwargs):
        super(GswHeadComponent, self).__init__(name, parent, *args, **kwargs)
...
class GswHeadComponentGuide(GswHeadComponent):
    ...
    def __init__(self, name='head', parent=None, *args, **kwargs):
        ...
        super(GswHeadComponentGuide, self).__init__(name, parent, *args, **kwargs)
        ...
        self.default_data = {
            "name": name,
            "location": "M",
            "headXfo": Xfo(Vec3(0.0, 15.178, -0.182)),
    ...
    def saveData(self):
        ...
        data = super(GswHeadComponentGuide, self).saveData()
    ...
    def loadData(self, data):
        ...
        super(GswHeadComponentGuide, self).loadData(data)
    ...
    def getRigBuildData(self):
        ...
        data = super(GswHeadComponentGuide, self).getRigBuildData()
    ...
    def getRigComponentClass(cls):
        ...
        return GswHeadComponentRig


class GswHeadComponentRig(GswHeadComponent):
    """Head Component Rig"""

    def __init__(self, name='head', parent=None):

        Profiler.getInstance().push("Construct Head Rig Component:" + name)
        super(GswHeadComponentRig, self).__init__(name, parent)
    ...
    def loadData(self, data=None):
        ...
        super(GswHeadComponentRig, self).loadData(data)
        ...
        self.jawCtrl.setCurveData(icon.bended_arrow)
...
ks.registerComponent(GswHeadComponentGuide)
ks.registerComponent(GswHeadComponentRig)
